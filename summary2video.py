...
parser.add_argument('-p', '--path', type=str, default='log/summe-split0/result_test.h5', help="path to h5 result file")
parser.add_argument('-d', '--frm-dir', type=str, default= 'frames/St Maarten Landing',help="path to frame directory")
...
parser.add_argument('--save-name', type=str, default='summary_StMaarten.mp4', help="video name to save (ends with .mp4)")
