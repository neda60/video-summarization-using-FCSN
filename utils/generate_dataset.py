...
class Generate_Dataset:
    ...
    def generate_dataset(self):
        for video_idx, video_filename in enumerate(tqdm(self.video_list)):
            print(video_filename, video_idx)
            video_path = video_filename
            if os.path.isdir(self.video_path):
                video_path = os.path.join(self.video_path, video_filename)

            video_basename = os.path.basename(video_path).split('.')[0]
            pth = os.path.join(self.frame_root_path, video_basename)
            ...
            # #self.h5_file.create_group('video_{}'.format(vid_id))
            # self.h5_file['video_{}'.format(vid_id)]['features'] = list(video_feat_for_train)
            # self.h5_file['video_{}'.format(vid_id)]['picks'] = np.array(list(picks))
            # self.h5_file['video_{}'.format(vid_id)]['n_frames'] = n_frames
            # self.h5_file['video_{}'.format(vid_id)]['fps'] = fps
            # self.h5_file['video_{}'.format(vid_id)]['change_points'] = change_points
            # self.h5_file['video_{}'.format(vid_id)]['n_frame_per_seg'] = n_frame_per_seg

if __name__ == "__main__":
    # # gen = Generate_Dataset('/Users/neda.ebrahimi/Desktop/vid_summ/SumMe/videos/', 'summe_dataset.h5')
    # gen = Generate_Dataset('/Users/neda.ebrahimi/Desktop/vid_summ/SumMe/videos/Air_Force_One.mp4', 'summe_dataset.h5')
    # gen.generate_dataset()
    # gen.h5_file.close()


    gen = Generate_Dataset('/Users/neda.ebrahimi/Desktop/vid_summ/SumMe/sample_vids/', 'summe_dataset.h5')
    #print(glob.glob('/Users/neda.ebrahimi/Desktop/vid_summ/SumMe/sample_vids/*.mp4'))
    # for vid in glob.glob('/Users/neda.ebrahimi/Desktop/vid_summ/SumMe/sample_vids/*.mp4'):
    #     #gen = Generate_Dataset('/Users/neda.ebrahimi/Desktop/vid_summ/SumMe/videos/Air_Force_One.mp4', 'summe_dataset.h5')
    #     print(vid)
    gen.generate_dataset()

    #print(gen.h5_file.keys())
    gen.h5_file.close()
