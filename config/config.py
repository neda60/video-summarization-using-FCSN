# ============ TRAIN CONFIG ==============
# Dataset options
DATASET = 'utils/summe_dataset.h5' # path to h5 dataset (required)
SPLIT = 'datasets/splits.json' # path to split file (required)
...
GPU = '-1' # which gpu devices to use (default: 0)
USE_CPU = True # use cpu device
EVALUATE = False # whether to do evaluation only
TEST = True # whether to do evaluation only
RESUME = 'log/summe-split0/model_epoch60.pth.tar' # path to resume file
